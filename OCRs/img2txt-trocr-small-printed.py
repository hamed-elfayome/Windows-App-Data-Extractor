...
with open("output-trocr-small-printed.csv", "w", newline="", encoding="utf-8") as csv_file:
...
for i in range(1, total_iterations):
    ...
    with open("output-trocr-small-printed.csv", "a", newline="", encoding="utf-8") as csv_file:
        csv_writer = csv.writer(csv_file)
